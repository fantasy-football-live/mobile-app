...
var map = {
	"../Pages/Home/home.module": [
		...
		"default~Pages-Home-home-module~Pages-Leagues-leagues-list-leagues-module~Pages-News-news-module~Page~798e5fa8",
		"default~Pages-Home-home-module~Pages-Leagues-leagues-list-leagues-module~Pages-Settings-settings-mod~d134829c",
		"common",
		"Pages-Home-home-module"
	],
	"../Pages/Leagues/leagues-list/leagues.module": [
	...
	"./Pages/Updating/updating.module": [
...
/***/ "./src/app/Services/Firebase/fcm.service.ts":
/*!**************************************************!*\
  !*** ./src/app/Services/Firebase/fcm.service.ts ***!
  \**************************************************/
...
var FcmService = /** @class */ (function () {
    ...
    FcmService.prototype.getToken = function (id) {
    ...
    FcmService.prototype.saveToken = function (id) {
        if (!this.token)
            return;
    ...
    FcmService = __decorate([
        ...
        __metadata("design:paramtypes", [_ionic_native_firebase_ngx__WEBPACK_IMPORTED_MODULE_2__["Firebase"], angularfire2_firestore__WEBPACK_IMPORTED_MODULE_1__["AngularFirestore"], _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["Platform"]])
    ], FcmService);
    return FcmService;
}());
...
var routes = [
    ...
    { path: 'updating', loadChildren: './Pages/Updating/updating.module#UpdatingPageModule' },
];
...
/* harmony import */ var _Services_Firebase_fcm_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./Services/Firebase/fcm.service */ "./src/app/Services/Firebase/fcm.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AppComponent = /** @class */ (function () {
    function AppComponent(platform, fcm, toastController, splashScreen, statusBar) {
        this.platform = platform;
        this.fcm = fcm;
    ...
    AppComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_1__["Platform"],
            _Services_Firebase_fcm_service__WEBPACK_IMPORTED_MODULE_5__["FcmService"],
...
/* harmony import */ var src_firebase_config__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! src/firebase.config */ "./src/firebase.config.ts");
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            imports: [
                ...
                angularfire2__WEBPACK_IMPORTED_MODULE_13__["AngularFireModule"],
            ...
            providers: [
                ...
                { provide: angularfire2__WEBPACK_IMPORTED_MODULE_13__["FirebaseOptionsToken"], useValue: src_firebase_config__WEBPACK_IMPORTED_MODULE_16__["default"] }
            ],
...
__webpack_require__.r(__webpack_exports__);
var config = {
    apiKey: 'AIzaSyDjd6XqSB35R06kIrZp1CVzwnV6zroI9jQ',
    authDomain: 'fantasy-football-live.firebaseapp.com',
    databaseURL: 'https://fantasy-football-live.firebaseio.com',
    projectId: 'fantasy-football-live',
    storageBucket: 'fantasy-football-live.appspot.com',
    messagingSenderId: '276208393080'
};
...
module.exports = __webpack_require__(/*! /Users/apple/Documents/Projects/FantasyApp/FantasyFootballLive/src/main.ts */"./src/main.ts");
